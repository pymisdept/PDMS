<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GraduateDetails.aspx.cs" Inherits="HR_EPMS.GraduateDetails" %>
                  ...
                  <div class="table-responsive">
                      <asp:GridView ID="grid_Edu" runat="server" CellSpacing="0"  AutoGenerateColumns="false" Width="100%" class="table table-bordered " OnRowDataBound="GridView1_RowDataBound">  
                           <Columns>     
                               ...
                               <asp:TemplateField HeaderText="Graduation Year<div>(mm/yyyy)</div>" HeaderStyle-CssClass="gridExpDate">  
                                    <ItemTemplate>             
                  ...
                  <div class="table-responsive">
                      <asp:GridView ID="grid_Exp" runat="server" CellSpacing="0"  AutoGenerateColumns="false" Width="100%" class="table table-bordered " OnRowDataBound="GridView1_RowDataBound">  
                           <Columns>     
                               ...
                               <asp:TemplateField HeaderText="Company" HeaderStyle-CssClass="gridDesc">   
                                   <ItemTemplate>           
                                           <div class="form-row">
                               ...
                               <asp:TemplateField HeaderText="Position" HeaderStyle-CssClass="gridExpInfo25">   
                                   <ItemTemplate>           
                                           <div class="form-row">
                                            <div class="col"  style="max-width: 400px" >

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Acknowledge2.aspx.cs" Inherits="HR_EPMS.Acknowledge" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div><%=userClaims?.FindFirst("preferred_username")?.Value %></div>
            ...
            <br />
            <div class="row">
                <h3>INVALID USER ! User has not been permitted to access the system !</h3>
            </div>
            <div class="col-sm-12">
            </div>
         </div>
